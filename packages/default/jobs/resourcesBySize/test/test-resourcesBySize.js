/**
 * Test file for Job: resourcesBySize
 */

var assert = require ('assert');
resourcesBySizeSUT = require('../resourcesBySize');

var mockedConfig, mockedDependencies;

describe ('resourcesBySize test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      resourcesBySizeSUT(config, mockedDependencies, function(err, data){
