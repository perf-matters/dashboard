/**
 * Test file for Job: pageLoadTimes
 */

var assert = require ('assert');
pageLoadTimesSUT = require('../pageLoadTimes');

var mockedConfig, mockedDependencies;

describe ('pageLoadTimes test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      pageLoadTimesSUT(config, mockedDependencies, function(err, data){
